...
const CONTEXT = require("org.pinf.lib/lib/context");
				...
				return findProgramRoot(process.cwd(), function (err, rootPath) {
					...
					return findPackageRoot(module.filename, function(err, ___program_root_path) {
						...
						try {
							...
							var API = {
								ASYNC: function (moduleIds, callback) {
									return Q.spread(moduleIds.map(function (moduleId) {
										var deferred = Q.defer();
										API.ASYNC[moduleId](function (exports) {
											return deferred.resolve(exports);
										}, deferred.reject);
										return deferred.promise;
									}), callback);
								},
...
throw new Error("STOP on getPinfDirectory");
								...
								getPinfDirpath: function () {
									...
									var epoch = process.env.PGS_PINF_EPOCH;
									return PATH.join(process.env.PGS_PINF_DIRPATH, epoch);
								},
...
throw new Error("STOP on getPackagesDirectory");
							...
							API.ASYNC.FORGE = function (cb) {
								return cb(require("node-forge"));
							};
